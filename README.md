1) This is first sable version of einburgerungs test app which is HTML based as of now and runs on local server so one needs tohost a server on his/her PC to run this app.
